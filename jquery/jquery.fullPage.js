    ...
    $.fn.fullpage = function(options) {
        ...
        */
        FP.moveSectionUp = function(){
            /*for my o my site's series page*/
            /*active section must be upper*/
            if(Sys.chrome){
                var currentUrl = $(SECTION_ACTIVE_SEL).children().children().css("background-image");
                var nextUrl = currentUrl;
                var format = currentUrl.substring(0,currentUrl.length-6);
                
                if($(SECTION_ACTIVE_SEL).prev().length){
                    //current to no color
                    var len = format.split('_')[0];
                    currentUrl = len +".jpg\")";
                }
                
                $(SECTION_ACTIVE_SEL).children().children().css("background-image",currentUrl);

                if($(SECTION_ACTIVE_SEL).prev().length){
                    nextUrl = $(SECTION_ACTIVE_SEL).prev().children().children().css("background-image");
                    //next to color
                    nextUrl = nextUrl.substring(0,nextUrl.length-6)+"_c.jpg\")";
                    nextUrl = nextUrl.replace("_c_c","_c");//滑快了~~去重复
                    $(SECTION_ACTIVE_SEL).prev().children().children().css("background-image",nextUrl);
                }
            }
            if(Sys.ie||Sys.firefox){
                ...
                if($(SECTION_ACTIVE_SEL).prev().length){
                    ...
                    //next to color
                    nextUrl = nextUrl.substring(0,nextUrl.length-6)+"_c.jpg\")";
                    nextUrl = nextUrl.replace("_c_c","_c");
                    $(SECTION_ACTIVE_SEL).prev().children().children().css("background-image",nextUrl);
                }
            }
        ...
        */
        FP.moveSectionDown = function (){
            ...
            if(Sys.chrome){
                ...
                if($(SECTION_ACTIVE_SEL).next().length && $(SECTION_ACTIVE_SEL).next().hasClass("section")){
                    //current to no color
                    var len = format.split('_')[0];
                    currentUrl = len+".jpg\")";
                }
                $(SECTION_ACTIVE_SEL).children().children().css("background-image",currentUrl);
                console.log($(SECTION_ACTIVE_SEL).children().children());
                if($(SECTION_ACTIVE_SEL).next().length && $(SECTION_ACTIVE_SEL).next().hasClass("section")){
                    nextUrl =  $(SECTION_ACTIVE_SEL).next().children().children().css("background-image");
                    //next to color
                    nextUrl = nextUrl.substring(0,nextUrl.length-6)+"_c.jpg\")";
                    nextUrl = nextUrl.replace("_c_c","_c");
                    $(SECTION_ACTIVE_SEL).next().children().children().css("background-image",nextUrl);
                }
            }
            if(Sys.ie||Sys.firefox){
                var currentUrl = $(SECTION_ACTIVE_SEL).children().children().css("background-image");
        ...
        */
        ...
        FP.reBuild = function(resizing){
            ...
            $(SECTION_SEL).each(function(){
                ...
                $(this).css('height', windowsHeight/2 + 'px');
        ...
        */
        function styleSection(section, index){
            ...
            section.css('height', windowsHeight/2 + 'px');
        ...
        */
        ...
        function getTableHeight(element){
            var sectionHeight = windowsHeight/2;
